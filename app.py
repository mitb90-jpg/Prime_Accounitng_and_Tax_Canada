...
VISA_DEBIT_RULES = {
    ...
    "BARTONPERREIRA|CARLZEISSVISION|DITA|KERING|LUXOTTICAOFCANADATORONTOON|MARCOLINCANADA|ORGREENGOLDSMITH|SAFILO|SALTOPTICS|THELIOS|SQSWEATANDTONICTORONTOON": "Purchases",
