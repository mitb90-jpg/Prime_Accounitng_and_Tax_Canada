...
VISA_DEBIT_RULES = {
    ...
    "BARTON PERREIRA|CARL ZEISS VISION|DITA|KERING|LUXOTTICA OF CANADA TORONTO ON|MARCOLIN CANADA|ORGREEN GOLDSMITH|SAFILO|SALT OPTICS|THELIOS|SQ *SWEAT AND TONIC": "Purchases",
