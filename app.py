...
VISA_DEBIT_RULES = {
    "ESSILOR|HCM|NIKONOPTICALMONTREALQC|ALCON|CANADIANOPTICAL|J&JVISIONCARE|MCCRAYOPTICAL|OPTICIANSASSOCIATION|SECUREOPTIONS": "Purchases",
    "REXALLPOSTOFFICE|ICS|UPS": "Delivery Expenses",
    "Google|CAAMEMBERSHIP|Adobe|": "Dues and Subscriptions",
    "Shell|Circle|COSTCOGAS|Petro|": "Fuel",
    ...
    "UBER|AIRCAN|CITYTOR.FERRYDOCKS|TCKTWEB|CURB|MIAMIAIRPCORONA|COCONUTGROVENEWSST2526|FGTEDCORLANDO|UPE|SIXT|ROAMI|RCL|Prestobay|Kasaliving|Expedia|ENTERPRISE|Canopy|Budgetrentacar|Avion|Austinairport|AirBnB|taxi": "Travel Expense",
    "MERCEDES-BENZ|CDNTIRESTORE|SIRIUSXM": "Vehicle Expense",
    "ELEGANCEDRYCLEANERS|HMHENNES|IHUC|LCBO|MECMOUNTAINEQUIPMENT|THEBEERSTORE": "Personal Expense",
    "EQUIFAX": "Admin Expenses",
    "Parking|PARK|BIKESHARE|TORPRKAUT|ERACTOLL|CP286POF": "Parking and Toll",
    "CATALYST": "Promotion",
    "PPL-21AVERD": "Rental",
    "Amazon|COSTCOWHOLESALE|WWWCOSTCO|AMZN|JAMESTOWNMILK|STARFRUITMARKET|STORMCROWMANOR|": "Supplies",
    "ROGERS|BELLCANADA|FIDOHome|MOBILEKLINIK|T-MOBILESTORE": "Telephone and Internet",
    
}
VISA_CREDIT_RULES = {
    "SCOTIABANKPAYMENT|Payment|PMT": "Credit Card Payments",
    "CreditAdjustment|Fee": "Other Income",
    "ELEGANCEDRYCLEANERS|REXALLPHARMACY|Aircan|ATLANTISEVENTSWEST|CANADAWIDEPARKING|AMZN|ACROUGE": "Refund",
