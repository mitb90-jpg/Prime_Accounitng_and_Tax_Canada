...
VISA_DEBIT_RULES = {
    ...
    "ELEGANCE DRY CLEANERS|HM HENNES|IHUC|LCBO|MEC MOUNTAIN EQUIPMENT|THE BEER STORE|NETFLIX|Air Can|BANANA REPUBLIC|MDHAIR|STORM CROW MANOR": "Personal Expense",
